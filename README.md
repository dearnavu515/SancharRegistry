...
- **Zero-Setup Database (SQLite)**: Submissions are saved locally in a `database.sqlite` file inside the project directory, removing the need for local database servers.
- **Admin Database Viewer**: An intuitive `admin.html` web dashboard to view, browse, and delete employee records from the database in real-time.
